...
class EventManager {
    ...
    _addDynamicEvents() {
        this.events.push(
            ...
            // === Lore Expansion Events ===
            { type: "IMPERIAL_TAX_CONVOY", probabilityPerFrame: 0.000006, minCooldownMs: 40 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "AUTHORITY: Imperial tax convoy sweeping trade lanes.", color: "cyan" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.IMPERIAL, fallbackShip: "ImperialCourier" }, aiRole: AI_ROLE.POLICE, spawnRadiusMin: 1600, spawnRadiusMax: 2200, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Tax Frigate"; e.faction = 'IMPERIAL'; } } },
            { type: "SEPARATIST_PRIVATEERS", probabilityPerFrame: 0.000006, minCooldownMs: 38 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "ALERT: Separatist privateers targeting independent shipping.", color: "orange" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 4, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.SEPARATIST, fallbackShip: "SeparatistPartisan" }, aiRole: AI_ROLE.PIRATE, spawnRadiusMin: 1700, spawnRadiusMax: 2400, additionalEnemySetup: (e) => { e.displayName = "Rebel Privateer"; e.faction = 'SEPARATIST'; } } },
            { type: "PILGRIM_ESCORT", probabilityPerFrame: 0.000007, minCooldownMs: 30 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "CONVOY: Pilgrim procession requests right of passage.", color: "cyan" }, spawnConfig: { entityType: 'enemy', minEntities: 3, maxEntities: 4, shipSelection: { strategy: 'randomFromList', shipList: ["PosthumanMissionary"], fallbackShip: "PosthumanMissionary" }, aiRole: AI_ROLE.MISSIONARY, spawnRadiusMin: 1500, spawnRadiusMax: 2200, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Pilgrim Convoy"; } } },
            { type: "ALIEN_RELIC_HUNTERS", probabilityPerFrame: 0.000005, minCooldownMs: 45 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "[ALIEN] ANOMALY: Alien relic hunters entering system.", color: "magenta" }, spawnConfig: { entityType: 'enemy', minEntities: 1, maxEntities: 2, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.ALIEN, fallbackShip: "Thargoid" }, aiRole: AI_ROLE.ALIEN, spawnRadiusMin: 1800, spawnRadiusMax: 2500, additionalEnemySetup: (e) => { e.displayName = "Relic Hunter"; } } },
            { type: "BLACK_OPS_INTERCEPTORS", probabilityPerFrame: 0.000005, minCooldownMs: 50 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "INTEL: Black-ops interceptors operating without transponders.", color: "red" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.BOUNTY_HUNTER, fallbackShip: "ViperBH" }, aiRole: AI_ROLE.BOUNTY_HUNTER, spawnRadiusMin: 1800, spawnRadiusMax: 2400, additionalEnemySetup: (e) => { e.currentState = AI_STATE.APPROACHING; e.displayName = "Black Ops Interceptor"; } } },
            { type: "STATION_EXTORTION_RING", probabilityPerFrame: 0.000006, minCooldownMs: 35 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "CRIME: Protection racketeers extorting dock traffic.", color: "red" }, spawnConfig: { entityType: 'enemy', minEntities: 3, maxEntities: 4, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.PIRATE, fallbackShip: "Sidewinder" }, aiRole: AI_ROLE.PIRATE, spawnRadiusMin: 1200, spawnRadiusMax: 1900, additionalEnemySetup: (e) => { e.displayName = "Extortionist"; } } },
            { type: "IMPERIAL_RETRIBUTION_WING", probabilityPerFrame: 0.000004, minCooldownMs: 55 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "MILITARY: Imperial retribution wing hunting dissidents.", color: "cyan" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.IMPERIAL, fallbackShip: "ImperialLancer" }, aiRole: AI_ROLE.COMBAT, spawnRadiusMin: 1900, spawnRadiusMax: 2600, additionalEnemySetup: (e) => { e.displayName = "Imperial Retributor"; e.faction = 'IMPERIAL'; } } },
            { type: "SEPARATIST_SIGNAL_JAMMERS", probabilityPerFrame: 0.0000045, minCooldownMs: 45 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "INTERFERENCE: Separatist jamming flotilla detected.", color: "orange" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.SEPARATIST, fallbackShip: "SeparatistShadow" }, aiRole: AI_ROLE.COMBAT, spawnRadiusMin: 1800, spawnRadiusMax: 2500, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Signal Jammer"; e.faction = 'SEPARATIST'; } } },
            { type: "HARLEQUIN_FLASHMOB", probabilityPerFrame: 0.000006, minCooldownMs: 30 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "CIRCUS: Harlequin flashmob strobing local traffic lanes.", color: "white" }, spawnConfig: { entityType: 'enemy', minEntities: 3, maxEntities: 4, shipSelection: { strategy: 'randomFromList', shipList: ["HarlequinPulcinella", "HarlequinPierrot", "HarlequinColumbine"], fallbackShip: "HarlequinPulcinella" }, aiRole: AI_ROLE.PIRATE, spawnRadiusMin: 1300, spawnRadiusMax: 2000, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Flashmob Marauder"; e.faction = 'HARLEQUIN'; } } },
            { type: "MISSIONARY_RECLAMATION_FLEET", probabilityPerFrame: 0.0000055, minCooldownMs: 33 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "SERMON: Reclamation fleet demanding ideological compliance.", color: "purple" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: ["PosthumanMissionary"], fallbackShip: "PosthumanMissionary" }, aiRole: AI_ROLE.MISSIONARY, spawnRadiusMin: 1500, spawnRadiusMax: 2100, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Reclamation Missionary"; } } },
            { type: "BORDER_MILITIA_DRILL", probabilityPerFrame: 0.000005, minCooldownMs: 42 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "EXERCISE: Border militia conducting live-fire drills.", color: "blue" }, spawnConfig: { entityType: 'enemy', minEntities: 3, maxEntities: 4, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.MILITARY, fallbackShip: "Viper" }, aiRole: AI_ROLE.COMBAT, spawnRadiusMin: 1700, spawnRadiusMax: 2400, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Militia Patrol"; } } },
            { type: "ALIEN_BIO_PROSPECTORS", probabilityPerFrame: 0.0000045, minCooldownMs: 48 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "[ALIEN] BIOSCAN: Prospectors sampling local biosignatures.", color: "magenta" }, spawnConfig: { entityType: 'enemy', minEntities: 1, maxEntities: 2, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.ALIEN, fallbackShip: "BioFrigate" }, aiRole: AI_ROLE.ALIEN, spawnRadiusMin: 1900, spawnRadiusMax: 2600, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Bio Prospector"; } } },
            { type: "DEFENSE_DRONE_SWEEP", probabilityPerFrame: 0.0000065, minCooldownMs: 28 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "SECURITY: Autonomous defense drones sweeping traffic lanes.", color: "cyan" }, spawnConfig: { entityType: 'enemy', minEntities: 2, maxEntities: 3, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.POLICE, fallbackShip: "ViperPol" }, aiRole: AI_ROLE.POLICE, spawnRadiusMin: 1400, spawnRadiusMax: 2100, additionalEnemySetup: (e) => { e.currentState = AI_STATE.PATROLLING; e.displayName = "Defense Drone"; } } },
            { type: "SHADOW_COURIER", probabilityPerFrame: 0.000005, minCooldownMs: 40 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "INTEL: Unmarked courier running dark through the sector.", color: "gold" }, spawnConfig: { entityType: 'enemy', minEntities: 1, maxEntities: 1, shipSelection: { strategy: 'randomFromList', shipList: this.shipGroups.TRADER, fallbackShip: "CobraMkIII" }, aiRole: AI_ROLE.HAULER, spawnRadiusMin: 2000, spawnRadiusMax: 2600, additionalEnemySetup: (e) => { e.currentState = AI_STATE.FLEEING; e.displayName = "Shadow Courier"; } } },
            { type: "ORBITAL_WRECKFIELD", probabilityPerFrame: 0.000008, minCooldownMs: 22 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "SALVAGE: Fresh orbital wreckfield shedding valuables.", color: "silver" }, spawnConfig: { entityType: 'cargo', minEntities: 2, maxEntities: 4, spawnRadiusMin: 1400, spawnRadiusMax: 2600, cargoType: 'Metals', quantity: 3 } },
            { type: "PILGRIM_OFFERINGS", probabilityPerFrame: 0.000007, minCooldownMs: 24 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "RITUAL: Pilgrims jettisoning tribute crates.", color: "gold" }, spawnConfig: { entityType: 'cargo', minEntities: 2, maxEntities: 3, spawnRadiusMin: 1300, spawnRadiusMax: 2200, cargoType: 'Luxury Goods', quantity: 2 } },
            { type: "SEPARATIST_ARMS_CACHE", probabilityPerFrame: 0.000006, minCooldownMs: 30 * 60 * 1000, warningDurationMs: 5000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "BLACKSITE: Hidden separatist arms cache exposed.", color: "orange" }, spawnConfig: { entityType: 'cargo', minEntities: 1, maxEntities: 2, spawnRadiusMin: 1700, spawnRadiusMax: 2600, cargoType: 'Weapons', quantity: 2 } },
            { type: "ALIEN_RELIC_CACHE", probabilityPerFrame: 0.000004, minCooldownMs: 55 * 60 * 1000, warningDurationMs: 6000, lastTriggeredTime: -Infinity, isWarningActive: false, eventTriggerTime: 0, warningConfig: { message: "[ALIEN] SIGNAL: Relic cache pulse detected.", color: "magenta" }, spawnConfig: { entityType: 'cargo', minEntities: 1, maxEntities: 1, spawnRadiusMin: 1900, spawnRadiusMax: 3000, cargoType: 'Alien Artifact', quantity: 1 } },
