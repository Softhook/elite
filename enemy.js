...
function _getRandomNamePart(list) {
...
function generateHumanEnemyName() {
    const first = _getRandomNamePart(HUMAN_ENEMY_FIRST_NAMES);
    const last = _getRandomNamePart(HUMAN_ENEMY_LAST_NAMES);
