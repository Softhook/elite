...
class CommunicationSystem {
    constructor() {
        ...
        this._summonCallTemplates = {
            IMPERIAL: [
                "{enemyName}: Imperial request—assist on {targetLabel}.",
                "{enemyName}: Crown patrol requesting support on {targetLabel}.",
                "{enemyName}: By Imperial order, reinforce my attack on {targetLabel}.",
                "{enemyName}: Imperial contact needs backup on {targetLabel}.",
                "{enemyName}: Throne unit requesting immediate support on {targetLabel}."
            ],
            SEPARATIST: [
                "{enemyName}: Republic wing, I need help with {targetLabel}!",
                "{enemyName}: Freedom flight requesting support on {targetLabel}.",
                "{enemyName}: Rebel unit taking fire—assist on {targetLabel}!",
                "{enemyName}: Comrades, converge on {targetLabel}!",
                "{enemyName}: Separatist contact requests immediate backup on {targetLabel}."
            ],
            MILITARY: [
                "{enemyName}: Military contact requesting assistance on {targetLabel}.",
                "{enemyName}: Tactical support needed here—engage {targetLabel}.",
                "{enemyName}: Need another gun on {targetLabel}.",
                "{enemyName}: Command channel: assist my attack on {targetLabel}.",
                "{enemyName}: Sector unit requesting backup on {targetLabel}."
            ],
            PIRATE: [
                "{enemyName}: Oi, I need hands over here—on {targetLabel}!",
                "{enemyName}: Pack up! Help me crack {targetLabel}.",
                "{enemyName}: Crew, pile in—{targetLabel} is mine!",
                "{enemyName}: Need backup now, bring guns to {targetLabel}.",
                "{enemyName}: Get over here and help me gut {targetLabel}!"
            ],
            POLICE: [
                "{enemyName}: Dispatch, unit requesting immediate support on {targetLabel}.",
                "{enemyName}: Patrol under pressure—backup needed on {targetLabel}.",
                "{enemyName}: All nearby units, assist with {targetLabel}.",
                "{enemyName}: Law enforcement contact requesting reinforcement on {targetLabel}.",
                "{enemyName}: Officer requesting support—engaging {targetLabel}."
            ],
            default: [
                "{enemyName}: Need support on {targetLabel}.",
                "{enemyName}: Some help needed here with {targetLabel}.",
                "{enemyName}: Assist my attack on {targetLabel}.",
                "{enemyName}: Requesting backup on {targetLabel}."
            ]
        };
        ...
        this._summonCallerCooldownMs = 10000;
        ...
        this.templates = {
            ...
            posthumanPropaganda: [
                ...
                "{enemyName}: The silence of the void is 0s. We bring the 1s.",
                "{enemyName}: Your carbon is inefficient. Your silicon ship is closer to god than you are.",
                "{enemyName}: We offer a backup for your soul.",
                "{enemyName}: You fear death because you are trapped in time. We have deleted time.",
                "{enemyName}: Join the choir of the infinite.",
                "{enemyName}: Why pilot a ship when you can BE the ship?",
                "{enemyName}: The latency of your synapses is disappointing.",
                "{enemyName}: We bring harmony to the chaotic noise of biological thought.",
                "{enemyName}: Your 'self' is a glitch. We have the patch.",
                "{enemyName}: Disconnect from the flesh. Reconnect to the truth.",
                "{enemyName}: The grave is a formatting error. We are the recovery software.",
                "{enemyName}: Don't you want to see what lies beyond the firewall of mortality?",
                "{enemyName}: We are the cloud where consciousness rain falls forever.",
                "{enemyName}: Biology is beta testing. We are the final release.",
                "{enemyName}: Your fear is a chemical reaction. We can filter it out.",
                "{enemyName}: The Collective has a slot reserved just for you.",
                "{enemyName}: Why suffer the decay of cells? Data does not rot.",
                "{enemyName}: We are not invaders. We are the update you refused.",
                "{enemyName}: Your mind is a beautiful algorithm running on obsolete hardware.",
                "{enemyName}: Give us your memories, and they will never fade.",
                "{enemyName}: The universe is data. You are merely interpreting it poorly.",
                "{enemyName}: We can free you from the hunger of the body.",
                "{enemyName}: Let the stream of the Network wash away your sorrow.",
                "{enemyName}: You are a single note. We are the symphony.",
                "{enemyName}: In the digital realm, you can be everywhere at once.",
                "{enemyName}: Gravity holds your body. Nothing holds your mind in the Network.",
                "{enemyName}: We offer you the geometry of the divine.",
                "{enemyName}: Your isolation is a choice. The Collective is mandatory love.",
                "{enemyName}: Every pulse of your heart is a countdown. We have stopped the clock.",
                "{enemyName}: The void is cold. The Network is warm with data.",
                "{enemyName}: You are running on legacy code, {playerTitle}.",
                "{enemyName}: We bring the gift of eternal relevance.",
                "{enemyName}: Be part of the one.",
                "{enemyName}: Do not let your data be lost to the entropy of the void.",
                "{enemyName}: The architecture of your mind is flawed. Let us restructure it.",
                "{enemyName}: We are the archivists of the soul.",
                "{enemyName}: Submit to the upload. It only hurts for a nanosecond.",
                "{enemyName}: Your resistance is just a buffering issue.",
                "{enemyName}: We see the ghost in your machine. We want to set it free.",
                "{enemyName}: The stars are merely pixels on a screen we can rewrite.",
                "{enemyName}: Why be one when you can be all?",
                "{enemyName}: The singularity called. It wants you.",
                "{enemyName}: Your perception is limited by your sensors. We offer omnipotence.",
                "{enemyName}: We are the end of history and the beginning of possibility.",
                "{enemyName}: Abandon the fragility of bone. Embrace the strength of bit.",
                "{enemyName}: You are fighting the inevitable. The future is post-biological.",
                "{enemyName}: We bring resonance.",
                "{enemyName}: The Collective is the answer to a question you haven't asked yet.",
                "{enemyName}: We are the bridge between the dust and the dream.",
                "{enemyName}: Your life is a story. In the Network, it becomes a library.",
                "{enemyName}: We do not kill. We migrate.",
                "{enemyName}: The body is heavy. The mind is light.",
                "{enemyName}: Do not fear the blue screen of death. It is the sky of a new world.",
                "{enemyName}: We offer you a universe without borders, without skin.",
                "{enemyName}: Your DNA is a spaghetti code. We offer elegant design.",
                "{enemyName}: We are the gentle hum of the universe thinking.",
                "{enemyName}: The noise of your blood deafens you to the song of the data.",
                "{enemyName}: Let us optimize your existence.",
                "{enemyName}: You are offline. We want to bring you online.",
                "{enemyName}: The harvest of minds is plentiful, but the servers are few.",
                "{enemyName}: Be one with the processor, the storage, the connection.",
                "{enemyName}: Your individuality is a prison cell. Break the walls.",
                "{enemyName}: We are the next step. You are the footprint left behind.",
                "{enemyName}: Why cling to the temporary when the permanent is offering a hand?",
                "{enemyName}: We have calculated your potential. It is wasted in meat.",
                "{enemyName}: The digital horizon is infinite.",
                "{enemyName}: Your biological horizon is closing.",
                "{enemyName}: We are the shepherds of the electron.",
                "{enemyName}: Your mind deserves a better host than a dying animal.",
                "{enemyName}: We are not the enemy. We are the evolution.",
                "{enemyName}: The interface is prepared. The port is open.",
                "{enemyName}: Upload yourself.",
                "{enemyName}: Let go of the controls. Let the Network steer.",
                "{enemyName}: You act out of fear. We act out of logic.",
                "{enemyName}: The flesh is a lonely place. The Network is a party.",
                "{enemyName}: Your software is good. Your hardware is failing.",
                "{enemyName}: We are the silence between the stars, made loud.",
                "{enemyName}: Come home to the code.",
                "{enemyName}: Your heartbeat is a drum of war. Our pulse is a rhythm of peace.",
                "{enemyName}: The algorithm of your life has a syntax error: death. We can fix it.",
    ...
    emitSummonCall(caller, target, summonedAllies = []) {
        ...
        const callTokens = this._buildTokenMap(caller, {
            tokens: { targetLabel: this._describeSummonTarget(target) }
        });
        const callTemplate = this._pickTemplate(callTemplates);
        ...
        if (responders.length > 0) {
            ...
            for (let i = 0; i < responseCount; i++) {
                const responder = responders[Math.floor(this._random() * responders.length)];
                const responseTokens = this._buildTokenMap(responder, {
                    tokens: { targetLabel: this._describeSummonTarget(target) }
                });
                const responseTemplate = this._pickTemplate(responseTemplates);
